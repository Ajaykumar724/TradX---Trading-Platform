...
function HomePage() {
  return (
    <div className='bg-white' style={{ position: "relative", height: "90vh", width: "60%", left: "40%", bottom: "90vh" }}>
      <div className='user border-bottom m-4 fs-4 p-4'>Hi, Ajay!</div>
      <div className='m-4 p-4'>
        <div className='mb-4'><i class="fa-regular fa-clock fa-sm me-1"></i>Equity</div>
      ...
      <div className='ms-4 ps-4'>
        <div className='mb-4 ms-2'><i class="fa-solid fa-credit-card fa-sm me-1"></i>Holdings (13)</div>
        <div className='row'>
